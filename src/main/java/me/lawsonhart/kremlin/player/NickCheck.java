...
public final class NickCheck {
    ...
    /** A colour in the legacy form: &#RRGGBB, or a single legacy colour character. */
    ...
    public static void main(final String[] args) {
        ...
        System.out.println("legacy      : " + two.legacy());
        ...
        final List<TextColor> colours = colours(two.legacy());
        ...
        final List<TextColor> manyColours = colours(many.legacy());
        ...
        check(colours(one.legacy()).size() == 1, "one stop gives one colour: " + one.legacy());

        final String essentials = two.legacy();
        ...
        check(!undecorated.legacy().matches("(?i).*&[k-or].*"),
                "no decoration codes when none are picked: " + undecorated.legacy());
        ...
        final String pairLegacy = pair.legacy().toLowerCase(Locale.ROOT);
        ...
        final String decoratedLegacy = decorated.legacy().toLowerCase(Locale.ROOT);
