...
final class Items {
    ...
    static ItemStack of(final Material material, final Component name, final Component... lore) {
    ...
    static ItemStack dyed(final TextColor colour, final Component name, final Component... lore) {
